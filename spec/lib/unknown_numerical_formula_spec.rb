require 'spec_helper'
require_relative '../../unknown_numerical_formula'
...
describe UnknownNumericalFormura do
  TEST_LIST.each do |l|
    id = l[0]
    input = l[1]
    expected = l[2].to_i

    it "formura id:#{id}, input:#{input}" do
      expect(UnknownNumericalFormura.calc(input)).to eq expected
    end
  end
end
